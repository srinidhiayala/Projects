...
"""
This file creates a mininet network with one router and 5 hosts in two
...
h1, h3 and h5 are in the 10.0.0.0/24 subnet, while h2 and h4 are in the
...
class NetworkTopo ( Topo ):
    """ A linux router connecting 5 hosts in two IP subnets. """
    def build( self, **_opts ):
        ...
        self.addLink( h5, r1, intfName2='r1-eth5' )
